...
const Benefits = ({ setSelectedPage }: Props) => {
  return (
    <div>
      <section
        id="benefits"
        className="mx-auto grid min-h-full w-5/6 py-[5rem] md:py-[20rem]"
      >
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="my-5 text-sm">
              ...
              autem laboriosam quae, maiores ducimus provident voluptatum
              nostrum aspernatur unde non consequuntur minima explicabo, dolore
              odio ratione perspiciatis consectetur aliquam! Adipisci!
            </p>
          </motion.div>
          {/* Benefits */}
          <motion.div
